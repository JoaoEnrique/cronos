            ...
            <div class="card card-teams" style="background: {{  $team->color  }}; border-radius: 0;">
                <div class="card-body card-body-team">
                    <div class="row" style="position: relative; margin: 0">
                        ...
                        <div class="" style="position: absolute; top: 0; right: 0;z-index: 1!important;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="{{route('message.update')}}" class="form-edit-public-team">
                                ...
                                {{-- MENSAGE --}}
                                <textarea style="min-height: 300px" class="form-control text-form-public-team @error('message') is-invalid @enderror" name="message" id="message" rows="3" placeholder="Mensagem">{{$message->text}}</textarea>

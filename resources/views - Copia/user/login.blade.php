                ...
                <div class="col" style="flex-wrap: wrap; position: relative;">
                    ...
                    <div class="row row-notification-login form-login" style="width: 100%">
                        ...
                        @if(session()->has('success'))
                            <div class="alert alert-success alert-dismissible fade form-login show" role="alert">
                                {{session()->get('success')}}
                        ...
                        @if(session()->has('danger'))
                            <div class="alert alert-danger alert-dismissible fade form-login show" role="alert">
                                {{session()->get('danger')}}
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                        @endif
